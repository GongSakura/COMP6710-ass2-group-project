...
public class Games {
     ...
     * Choose a new games, given a difficulty level.
     * The game comes with five difficulty levels:starter, junior, expert, master, and wizard,
     ...
     * @return A games at the appropriate level of difficulty.
     */
    public static Games newGame(int difficulty) {
       ...
       int n = random.nextInt(24) + difficulty * 24;
       return SOLUTIONS[n];
    }
